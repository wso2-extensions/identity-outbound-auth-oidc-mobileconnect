                ...
                <div class="container col-xs-10 col-sm-6 col-md-6 col-lg-4 col-centered wr-content wr-login col-centered">
                    <div>
                        <h2 class="wr-title blue-bg padding-double white boarder-bottom-blue margin-none">
                            Authenticating with Mobile Connect &nbsp;&nbsp;</h2>
                                    ...
                                    <div class="row">
                                        <div class="span6">
                                             ...
                                             <div class="control-group">
                                                <label class="control-label" for="msisdn">Mobile Number: </label>
                                                <input type="text" id='msisdn' name="msisdn" class="input-xlarge" size='30' placeholder="94777123123" required/>
                                             </div>
                                             <input type="hidden" name="sessionDataKey"
                                                value='<%=request.getParameter("sessionDataKey")%>'/>
                                             <div> <input type="image" src="images/mcloginbtn.png" alt="submit" style="height:75px; width:200px"></div>
                                        </div>
                                    </div>
                                </div>
                            </form>
